            ...
            <div className="row">
              ...
              <div className="col-auto mb-3 mb-md-0 me-auto">
                <div className="w-auto sw-md-30">
                  ...
                  <h1 className="mb-0 pb-0 display-4" id="title">Order List(OA)</h1>
                </div>
              </div>
              {/* <!-- Title End --> */}
                ...
                {/* <div className="btn-group ms-1 check-all-container">
                  ...
                  <div className="dropdown-menu dropdown-menu-end">
                    <a className="dropdown-item" href="#">
                      <span className="align-middle d-inline-block">Status</span>
                    </a>
                    <a className="dropdown-item" href="#">
                      <span className="align-middle d-inline-block">Move</span>
                    </a>
                    <a className="dropdown-item" href="#">
                      <span className="align-middle d-inline-block">Delete</span>
                    </a>
                  </div>
                </div> */}
                {/* <!-- Check Button End --> */}
                ...
                <div className="card mb-2">
                  <div className="card-body pt-0 pb-0 sh-21 sh-md-8">
                    <div className="row g-0 h-100 align-content-center">
                      <div className="col-11 col-md-2 d-flex flex-column justify-content-center mb-2 mb-md-0 order-1 order-md-1 h-md-100 position-relative">
                        <div className="text-muted text-small d-md-none">Id</div>
                        <a href="/orderadmin-view-order" className="text-truncate h-100 d-flex align-items-center">1573</a>
                      </div>
                      <div className="col-6 col-md-3 d-flex flex-column justify-content-center mb-2 mb-md-0 order-3 order-md-2">
                        <div className="text-muted text-small d-md-none">Name</div>
                      ...
                      <div className="col-6 col-md-2 d-flex flex-column justify-content-center mb-2 mb-md-0 order-last order-md-5">
                        <div className="text-muted text-small d-md-none">Status</div>
                        <div className="text-alternate">
                          <span className="badge rounded-pill bg-outline-secondary">RECEIVED</span>
                        </div>
                      </div>
                ...
                <div className="card mb-2">
                  <div className="card-body pt-0 pb-0 sh-21 sh-md-8">
                    <div className="row g-0 h-100 align-content-center">
                      <div className="col-11 col-md-2 d-flex flex-column justify-content-center mb-2 mb-md-0 order-1 order-md-1 h-md-100 position-relative">
                        <div className="text-muted text-small d-md-none">Id</div>
                        <a href="/orderadmin-view-order" className="text-truncate h-100 d-flex align-items-center">2411</a>
                      </div>
                      <div className="col-6 col-md-3 d-flex flex-column justify-content-center mb-2 mb-md-0 order-3 order-md-2">
                        <div className="text-muted text-small d-md-none">Name</div>
                      ...
                      <div className="col-6 col-md-2 d-flex flex-column justify-content-center mb-2 mb-md-0 order-5 order-md-4">
                        <div className="text-muted text-small d-md-none">Date</div>
                        <div className="text-alternate">22.09.2020</div>
                      </div>
                      <div className="col-6 col-md-2 d-flex flex-column justify-content-center mb-2 mb-md-0 order-last order-md-5">
                        <div className="text-muted text-small d-md-none">Status</div>
                        <div className="text-alternate">
                          <span className="badge rounded-pill bg-outline-tertiary">SHIPPED</span>
                        </div>
                      </div>
