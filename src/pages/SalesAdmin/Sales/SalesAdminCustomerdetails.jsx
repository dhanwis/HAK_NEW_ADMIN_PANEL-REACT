...
function SalesAdminCustomerdetails() {
  return (
    <div>
        <main>
            ...
            <div className="row">
              ...
              <div className="col-auto mb-3 mb-md-0 me-auto">
                <div className="w-auto sw-md-30">
                  <a href="/salesadmin-customerlist" className="muted-link pb-1 d-inline-block breadcrumb-back">
                ...
                <div className="card-body">
                  <form>
                    <div className="mb-3">
                      ...
                      <input className="form-control" name="tagsBasic" value="Rates, Sales Shopper, Newsletter" />
                    </div>
                    <div className="mb-0">
...
export default SalesAdminCustomerdetails