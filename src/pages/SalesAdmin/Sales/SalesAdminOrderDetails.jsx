...
function SalesAdminOrderDetails() {
  return (
    <div>
        <main>
        <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-auto mb-3 mb-md-0 me-auto">
                <div class="w-auto sw-md-30">
                  <a href="/salesadmin-order" class="muted-link pb-1 d-inline-block breadcrumb-back">
                  ...
                  <div class="col-12 col-sm-6 col-lg-6">
                    <div class="card sh-13 sh-lg-15 sh-xl-14">
                      <div class="h-100 row g-0 card-body align-items-center py-3">
                        ...
                        <div class="col-auto"data-bs-toggle="modal" data-bs-target="#orderStatusModal">
                  ...
                  <div class="col-12 col-sm-6 col-lg-6">
                    <div class="card sh-13 sh-lg-15 sh-xl-14">
                      <div class="h-100 row g-0 card-body align-items-center py-3">
                        ...
                        <div class="col-auto"data-bs-toggle="modal" data-bs-target="#deliveryDateModal">
                        <button class="btn btn-sm btn-icon btn-icon btn-icon-only btn-outline-primary" type="button">
                          <i className="fa-solid fa-pen"></i>
                        </button>
                      </div>
          ...
          <div className="modal modal-right fade" id="orderStatusModal" tabindex="-1" role="dialog" aria-hidden="true">
            <div className="modal-dialog">
              <div className="modal-content">
                <div className="modal-header">
                  <h5 className="modal-title">Order Status Upate</h5>
                ...
                <div className="modal-body">
                  <form>
                   ...
                   <div className="form-check from-check-block">
                    <input type='radio' class="form-check-input" name="orderStatus/"></input>
          ...
          {/* <!-- Discount Add Modal End --> */}
           ...
           {/* <!-- date Add Modal Start --> */}
           <div className="modal modal-right fade" id="deliveryDateModal" tabindex="-1" role="dialog" aria-hidden="true">
            <div className="modal-dialog">
              <div className="modal-content">
                <div className="modal-header">
                  <h5 className="modal-title">Order Status Upate</h5>
...
export default SalesAdminOrderDetails