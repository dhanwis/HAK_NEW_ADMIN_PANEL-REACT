...
function OrderAdminView() {
  ...
  useEffect(() => {
      axios.get(`${BASE_URL}/superadmin/order-admin-profile/${id}/`)
          .then(response => {
            ...
            <div className="col-xl-4 mb-n5">
              ...
              <div className="mb-5">
                ...
                <div className="card">
                  <div className="card-body">
                    {/* <form> */}
                      <div className="dropzone dropzone-columns row g-2 row-cols-1 row-cols-md-1 border-0 p-0" ><img src={`${BASE_URL}${user.image}`} alt="user"/></div>
                    {/* </form> */}
                  </div>
                </div>
              </div>
