        ...
        <div className="container">
            ...
            <div className="row g-0">
              ...
              <div className="col-auto mb-3 mb-md-0 me-auto">
                <div className="w-auto sw-md-40">
                  ...
                  <h1 className="mb-0 pb-0 display-4" id="title">Sales Admin View</h1>
                </div>
              </div>
              {/* <!-- Title End --> */}
          ...
          <div className="row">
            <div className="col-xl-8">
              {/* <!-- Sales Info Start --> */}
              <div className="mb-5">
                <h2 className="small-title">Sales Admin View</h2>
                <div className="card">
